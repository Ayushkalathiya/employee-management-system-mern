...
//         try{
//             await db.query("Update Credentials set Password=$1 where EmployeeID=$2",[hash,userName])
//         }
//         catch(err){
//             console.log(err);
//         }
...
//     res.render("./pages/Employee/employee.ejs");    
// });

// app.get("/emp/profile" , async(req,res)=>{
//     res.render("./pages/Employee/profile.ejs");
// });

// //for leave
// app.get("/emp/leave", async(req,res)=>{
//     res.render("./pages/Employee/leave.ejs");
// });
