...
module.exports.verifyEmail = async(req, res)=>{
    ...
    let EmpID = decoded.EmpID;
    let EmpFName = decoded.EmpFName;
    let EmpLName = decoded.EmpLName;
    let EmpPosition = decoded.EmpPosition;
    let EmpEmail = decoded.EmpEmail;
    let roleID = decoded.roleID;
    let EmpSal= decoded.EmpSal;
    let EmpDepartment = decoded.EmpDepartment;
    ...
    const empAdder = await db.query("SELECT FirstName || ' ' || LastName AS Name, Position from Employees where employeeid = $1",[EmpID]);
...
console.log(EMNAME);
    ...
    res.render("./pages/EmailVerified.ejs");
};